...
All of the documentation and planning work in Phases 1 - 3 was done directly on the main branch.  Feature branches were created starting with Phase 4.

When using ChatGPT, it's best to use the web version because it's easier to copy the entire chat history.
...
- used Cursor and Claude Opus 4.8, in Plan mode
